...
Migrate legacy workspace memory files to Honcho. The Honcho plugin is already installed.
...
**Keep originals in place** (these are active workspace docs updated in Step 5):
- `AGENTS.md`
- `TOOLS.md`
- `SOUL.md`
- `BOOTSTRAP.md`
...
If the upload in Step 3 failed or was skipped, **do not archive or remove any files**. Warn the user that all files are preserved to prevent data loss.
